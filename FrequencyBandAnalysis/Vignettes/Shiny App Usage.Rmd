...
```{r, echo=FALSE, fig.cap="Screenshot of Application upon Opening", out.width = '90%'}
knitr::include_graphics("C:/Users/Dylan/Downloads/BlankShinyApp.png")
```
...
Note: Within the FrequencyBandAnalysis folder, there is a subfolder entitled "Sample Data", which contains every type of Univariate, Multivariate, and Functional data that can be simulated by the functions utilized here. These files serve to give the user some data they can use to run through this side of the application. However, the user is not limited to using just this data, as they can utilize any data they choose.
...
```{r, echo=FALSE, fig.cap="Screenshot of Simulation Setting side upon Opening", out.width = '90%'}
knitr::include_graphics("C:/Users/Dylan/Downloads/SimSettingDefault.png")
```
