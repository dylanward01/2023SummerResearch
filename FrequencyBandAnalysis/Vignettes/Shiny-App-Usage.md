...
4.  Once you are finished selecting values for the options seen, you can press the "Run" button, which will run the algorithm on your data, with the selected values as parameters.
